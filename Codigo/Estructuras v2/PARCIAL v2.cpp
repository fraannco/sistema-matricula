...
void MostrarRegistro(FILE *I, EXPARCIAL RegistroC);
void BuscarRegistro(FILE *I, EXPARCIAL RegistroC);
void EliminarRegistro(FILE *I, FILE *J,struct EXPARCIAL RegistroC);
void EditarRegistro(FILE *I ,FILE *J,struct EXPARCIAL RegistroC);
...
int  MenuPRINCIPAL()
{
   ...
   cout << "\n\n\n\r 0.- TERMINAR";
   cout << "\n\r [1] LECTURA DEL ARCHIVO PARCIAL";
...
void MostrarRegistro(FILE *I, EXPARCIAL RegistroC){
   ...
   while(!feof(I)){
      ...
      printf("\n\r %6s\t\t%-30s\t%-4.1f\t",RegistroC.codAlu, RegistroC.codCur, RegistroC.expar);
      fread(&RegistroC,sizeof(RegistroC),1,I);
...
void EliminarRegistro(FILE *I ,FILE *J,struct EXPARCIAL RegistroC){
   ...
   remo=remove("Parcial.dat");

   rena=rename("Temporal.dat","Parcial.dat");
...
void EditarRegistro(FILE *I ,FILE *J,struct EXPARCIAL RegistroC){
   ...
   rena=rename("Temporal2.dat","Parcial.dat");
